...
export default function TabContent({ reading = 49 }) {
  return (
    <Box>
      <Flex direction="column" align="center">
        <Circle size="150px" bg="#67A2DC">
          <Circle size="130px" bg="white">
            <CircularProgress
              trackColor="white"
              size="147px"
              value={reading}
            ...
            >
              <CircularProgressLabel>
                <Heading fontFamily="csBold" fontSize={"36px"}>
                  {reading}%
                </Heading>
              </CircularProgressLabel>
            </CircularProgress>
        ...
        <Flex>
          <Text color="#0466C8" lineHeight="30.5px" letterSpacing="-0.08px">
            ₦50,000
          </Text>
          <Text color="#707480" lineHeight={"30.5px"} letterSpacing="-0.08px">
            /₦120,000
          </Text>
        </Flex>
      </Flex>
      ...
      <Flex justifyContent="space-between" mb="5">
        ...
        <Flex>
          <Text color="#001233" lineHeight="30.5px" letterSpacing="-0.08px">
            ₦20,000/
          </Text>
          <Text color="#C1C4CD" lineHeight={"30.5px"} letterSpacing="-0.08px">
            ₦42,000
          </Text>
        </Flex>
      </Flex>
